<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bookingdetails.aspx.cs" Inherits="admin_bookingdetails" %>
    ...
    <!-- Collect the nav links, forms, and other content for toggling -->
                    <div class="collapse navbar-collapse dropdown-box" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right" style="margin-top: 6px;font-size: 15px;">
                          ...
                          <li><a href="../admin/bookingdetails.aspx" class="active">Booking Details</a></li>
      ...
      <br />
        ...
        <br />
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="display" runat="server" Text="Display Booking Details" CssClass="btn btn-warning" OnClick="display_Click1" />
        <br />
        <br />
    <div>

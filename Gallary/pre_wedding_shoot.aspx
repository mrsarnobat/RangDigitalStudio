<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pre_wedding_shoot.aspx.cs" Inherits="Gallary_pre_wedding_shoot" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Pre-Wedding Shoot</title>
    ...
    <!-- Collect the nav links, forms, and other content for toggling -->
        ...
        <div align="center">
            <table>
                <tr>
                    <th colspan="5">
                        <h2 class="text-style"><b>Outdoor Shoot Albums</b></h2>
                    </th>
                </tr>
                <tr>
                  <th>
                    <img src="../Images/outdoorshoot/1.jpg" class="img-gal-size-port" />
                  </th>
                    <th>
                    <img src="../Images/outdoorshoot/2.jpg" class="img-gal-size-port"/>
                  </th>
            
                  <th>
                    <img src="../Images/outdoorshoot/3.jpg" class="img-gal-size-port"/>
                  </th>
            
                  <th>
                    <img src="../Images/outdoorshoot/4.jpg" class="img-gal-size-port"/>
                  </th>
                  <th>
                    <img src="../Images/outdoorshoot/5.jpg" class="img-gal-size-port"/>
                  </th>
                </tr>
                <tr>
                  <th>
                    <img src="../Images/outdoorshoot/6.jpg" class="img-gal-size-port" />
                  </th>
                    <th>
                    <img src="../Images/outdoorshoot/7.jpg" class="img-gal-size-port"/>
                  </th>
            
                  <th>
                    <img src="../Images/outdoorshoot/8.jpg" class="img-gal-size-port"/>
                  </th>
            
                  <th>
                    <img src="../Images/outdoorshoot/9.jpg" class="img-gal-size-port"/>
                  </th>
                  <th>
                    <img src="../Images/outdoorshoot/10.jpg" class="img-gal-size-port"/>
                  </th>
                </tr>

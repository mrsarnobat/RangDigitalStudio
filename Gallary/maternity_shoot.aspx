<%@ Page Language="C#" AutoEventWireup="true" CodeFile="maternity_shoot.aspx.cs" Inherits="Gallary_maternity_shoot" %>
    ...
    <!-- Collect the nav links, forms, and other content for toggling -->
        ...
        <div align="center">
            <table>
                <tr>
                    <th>
                        <h2 class="text-style"><b>Materinity Albums</b></h2>
                    </th>
                </tr>
                <tr>
                  <th>
                    <img src="../Images/maternity/1.jpg" class="img-gal-size-land" />
                  </th>
                    <th>
                    <img src="../Images/maternity/2.jpg" class="img-gal-size-land"/>
                  </th>
            
                  <th>
                    <img src="../Images/maternity/3.jpg" class="img-gal-size-land"/>
                  </th>
            
                  <th>
                    <img src="../Images/maternity/4.jpg" class="img-gal-size-land"/>
                  </th>
                </tr>
                <tr>
                  <th>
                    <img src="../Images/maternity/5.jpg" class="img-gal-size-land" />
                  </th>
                    <th>
                    <img src="../Images/maternity/6.jpg" class="img-gal-size-land"/>
                  </th>
            
                  <th>
                    <img src="../Images/maternity/7.jpg" class="img-gal-size-land"/>
                  </th>
            
                  <th>
                    <img src="../Images/maternity/8.jpg" class="img-gal-size-land"/>
                  </th>
                </tr>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="indoor_shoot.aspx.cs" Inherits="Gallary_indoor_shoot" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Indoor Shoot</title>
    ...
    <!-- Collect the nav links, forms, and other content for toggling -->
        ...
        <div align="center">
            <table>
                <tr>
                    <th colspan="5">
                        <h2 class="text-style"><b>Indoor Shoot Albums</b></h2>
                    </th>
                </tr>
                <tr>
                  <th>
                    <img src="../Images/indoorshoot/1.jpg" class="img-gal-size-port" />
                  </th>
                    <th>
                    <img src="../Images/indoorshoot/2.jpg" class="img-gal-size-port"/>
                  </th>
            
                  <th>
                    <img src="../Images/indoorshoot/3.jpg" class="img-gal-size-port"/>
                  </th>
            
                  <th>
                    <img src="../Images/indoorshoot/4.jpg" class="img-gal-size-port"/>
                  </th>
                  <th>
                    <img src="../Images/indoorshoot/5.jpg" class="img-gal-size-port"/>
                  </th>
                </tr>
                <tr>
                  <th>
                    <img src="../Images/indoorshoot/6.jpg" class="img-gal-size-port" />
                  </th>
                    <th>
                    <img src="../Images/indoorshoot/7.jpg" class="img-gal-size-port"/>
                  </th>
            
                  <th>
                    <img src="../Images/indoorshoot/8.jpg" class="img-gal-size-port"/>
                  </th>
            
                  <th>
                    <img src="../Images/indoorshoot/9.jpg" class="img-gal-size-port"/>
                  </th>
                  <th>
                    <img src="../Images/indoorshoot/1.jpg" class="img-gal-size-port"/>
                  </th>

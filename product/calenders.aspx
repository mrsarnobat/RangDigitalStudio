<%@ Page Language="C#" AutoEventWireup="true" CodeFile="calenders.aspx.cs" Inherits="product_calenders" %>
    ...
    <!-- Collect the nav links, forms, and other content for toggling -->
        ...
        <div align="left" style="margin-left:30px">
            <table>
                <tr>
                    <th>
                        <h2 class="text-style"><b>Calenders</b></h2>
                    </th>
                </tr>
                <tr>
                  <th>
                      <a href="calender/tabletopcalender.aspx" style="text-decoration:none">
                    <img src="../Images/calender/1.png" class="img-gal-size-land" />
                     <p><h3 style="color:aliceblue;">&nbsp;&nbsp;&nbsp;Tabletop Calender</h3></p>
                          </a>
                  </th>
                    <th>
                        <a href="calender/wallmountcalender.aspx" style="text-decoration:none">
                    <img src="../Images/calender/2.png" class="img-gal-size-land"/>
                        <p><h3 style="color:aliceblue;">&nbsp;&nbsp;&nbsp;Wallmount Calendar</h3></p>
                            </a>
                  </th>
                    </tr>
                </table>

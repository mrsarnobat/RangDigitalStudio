<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wallmountcalender.aspx.cs" Inherits="product_calender_wallmountcalender" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Wallmount Calender</title>
            ...
            <table class="container" style="border-radius:10px;background-color:#cac8c154">
                ...
                <tr>
                    <th rowspan="2" class="auto-style2">
                        <br />
                        <img src="../../Images/calender/2.png" class="auto-style1"/>
                    </th>
                    <th>
                        <h2 style="color:#ff6a00"><i>Table Top Calender</i></h2>
                ...
                <tr>
                    <th class="auto-style2">
                        <div>
                       <h3 style="margin:10px;color:#010000"><b>Table Top Calender</b></h3>
                        <p style="margin:10px;color:#202122">
                            He complete authograph book comes with designing + printing + binding + Digital Pad and is printed on genration next of photo offering more Reality & Clarity to Images
                        </p>
                        <p style="margin:10px;color:#202122">
                            Panoramic uninterrupted view can have better design possibilites and hence add beauty to album.
                        </p>
                            </div>
                    </th>
                    <th rowspan="20">
                        <div id="h1" class="panel" style="margin:10px;">
                            ...
                            <ol>
                                <li>The complete Autograph book</li>
                                <li>Available in Importes Natural paper</li>
                                <li>Design + Print + Blind + Digital Pad</li>
                                <li>Minimum 20 photos. Maximum 60 photos.</li>
                                <li>Available in only 12 x 24 with 20 pages book.</li>
                                <li>Light weight</li>
                                <li>Full open</li>
                            ...
                            <h5 style="margin-left:10px">Only in 12 x 24 - 20 pages</h5>
                            <h4 style="margin-left:10px">Pages</h4>
                            <h5 style="margin-left:10px">Minimum Photos: 20</h5>
                            <h5 style="margin-left:10px">Maximum Photos: 30</h5>

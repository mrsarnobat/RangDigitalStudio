<%@ Page Language="C#" AutoEventWireup="true" CodeFile="iris.aspx.cs" Inherits="product_albums_iris" %>
            ...
            <table class="container" style="border-radius:10px;background-color:#cac8c154">
                ...
                <tr>
                    <th rowspan="2" class="auto-style2">
                        <br />
                        <img src="../../Images/Albums/7.png" class="auto-style1"/>
                    </th>
                    <th>
                        <h2 style="color:#ff6a00"><i>Iris</i></h2>
                ...
                <tr>
                    <th class="auto-style2">
                        <div>
                       <h3 style="margin:10px;color:#010000"><b>Iris</b></h3>
                        <p style="margin:10px;color:#202122">
                            iris is the most economical album available in India that is available in varieties of special finish such as Glossy Touch, Silk Touch, Leather Touch, Linen Touch, and Smooth Touch.
                        </p>
                        <p style="margin:10px;color:#202122">
                    ...
                    <th rowspan="20">
                        <div id="h1" class="panel" style="margin:10px;">
                            ...
                            <ol>
                                <li>The most economical album in India today.</li>
                                <li>Available in varieties of special finish.r</li>
                                <li>Panoramic uninterrupted view can have better design possibilities and hence add beauty to album</li>
                                <li>Layflat design</li>
                                <li>Photographic prints offers more Reality & Clarity to Images</li>
                         
                            </ol>
                            <hr style="width:50%;" align="center" />
                            <h4 style="margin-left:10px">Sizes</h4>
                            <h5 style="margin-left:10px">12 x 18, 12 x 24, 12 x 30, 12 x 36</h5>
                            <h4 style="margin-left:10px">Pages</h4>
                            <h5 style="margin-left:10px">Minimum Pages: 16</h5>
                            <h5 style="margin-left:10px">Maximum Pages: 17</h5>
                            <h4 style="margin-left:10px">Type of Finishes</h4>
                            <h5 style="margin-left:10px">Glossy</h5>
                            <h5 style="margin-left:10px">Silk</h5>
                            <h5 style="margin-left:10px">Leather</h5>
                            <h5 style="margin-left:10px">Linen</h5>
                            <h5 style="margin-left:10px">Smooth</h5>
                            <h4 style="margin-left:10px">Cover pad</h4>
                            <h5 style="margin-left:10px">Handmade Pad</h5>
                            <h5 style="margin-left:10px">photo pad</h5>
                            <h5 style="margin-left:10px">Leather pad</h5>

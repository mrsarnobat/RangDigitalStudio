<%@ Page Language="C#" AutoEventWireup="true" CodeFile="daisy.aspx.cs" Inherits="product_albums_daisy" %>
            ...
            <table class="container" style="border-radius:10px;background-color:#cac8c154">
                ...
                <tr>
                    <th rowspan="2" class="auto-style2">
                        <br />
                        <img src="../../Images/Albums/3.png" class="auto-style1"/>
                    </th>
                    <th>
                        <h2 style="color:#ff6a00"><i>Daisy</i></h2>
                ...
                <tr>
                    <th class="auto-style2">
                        <div>
                       <h3 style="margin:10px;color:#010000"><b>Daisy</b></h3>
                        <p style="margin:10px;color:#202122">
                            The international design album that comes with design + print + bind + digital pad / HMP and is printed on generation next of photo paper offering more Reality & Clarity to Images 
                        </p>
                        <p style="margin:10px;color:#202122">
                    ...
                    <th rowspan="20">
                        <div id="h1" class="panel" style="margin:10px;">
                            ...
                            <h5 style="margin-left:10px">Only in 12 x 36</h5>
                            <h4 style="margin-left:10px">Pages</h4>
                            <h5 style="margin-left:10px">Minimum Photos: 200</h5>
                            <h5 style="margin-left:10px">Maximum Photos: 300</h5>
                            <h4 style="margin-left:10px">Type of Finishes</h4>
                            <h5 style="margin-left:10px">Photographer - Vishal Modak, Monish Patil</h5>
                            <h5 style="margin-left:10px">Digital - Nt Thermal Gloss, NT Thermal Velvet, NT Thermal matt</h5>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jasmine.aspx.cs" Inherits="product_albums_jasmine" %>
            ...
            <table class="container" style="border-radius:10px;background-color:#cac8c154">
                ...
                <tr>
                    <th rowspan="2" class="auto-style2">
                        <br />
                        <img src="../../Images/Albums/8.png" class="auto-style1"/>
                    </th>
                    <th>
                        <h2 style="color:#ff6a00"><i>Jasmine</i></h2>
                ...
                <tr>
                    <th class="auto-style2">
                        <div>
                       <h3 style="margin:10px;color:#010000"><b>Jasmine</b></h3>
                        <p style="margin:10px;color:#202122">
                           With both side printing, Jasmine album is printed on renedeous natural paper that makes it long lasting due to ink been part of the paper.
                        </p>
                        <p style="margin:10px;color:#202122">
                            The Jasmine album is designed around all sorts of engaging stories keeping all Indian traditions in mind. 
                        </p>
                            </div>
                    </th>
                    <th rowspan="5">
                        <div id="h1" class="panel" style="margin:10px;">
                            ...
                            <ol>
                                <li>Printed on renedeous imported natural paper</li>
                                <li>This exclusive album is most suitable for portrait and candid style of photography</li>
                                <li>Designed around Indian traditional story lines</li>
                                <li>Handmade Italian binding</li>
                                <li>Includes full wrap digital pad and image box</li>

                            </ol>
                            <hr style="width:50%;" align="center" />
                            <h4 style="margin-left:10px">Sizes</h4>
                            <h5 style="margin-left:10px">12 x 18</h5>
                            <h4 style="margin-left:10px">Pages</h4>
                            <h5 style="margin-left:10px">Minimum Pages: 40</h5>

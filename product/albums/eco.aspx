<%@ Page Language="C#" AutoEventWireup="true" CodeFile="eco.aspx.cs" Inherits="product_albums_eco" %>
            ...
            <table class="container" style="border-radius:10px;background-color:#cac8c154">
                ...
                <tr>
                    <th rowspan="2" class="auto-style2">
                        <br />
                        <img src="../../Images/Albums/6.png" class="auto-style1"/>
                    </th>
                    <th>
                        <h2 style="color:#ff6a00"><i>Eco</i></h2>
                ...
                <tr>
                    <th class="auto-style2">
                        <div>
                       <h3 style="margin:10px;color:#010000"><b>Eco</b></h3>

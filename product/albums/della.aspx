<%@ Page Language="C#" AutoEventWireup="true" CodeFile="della.aspx.cs" Inherits="product_albums_della" %>
         ...
         <div >
            <table class="container" style="border-radius:10px;background-color:#cac8c154">
                ...
                <tr>
                    ...
                    <th>
                        <h2 style="color:#ff6a00"><i>Della</i></h2>
                ...
                <tr>
                    <th class="auto-style2">
                        <div>
                       <h3 style="margin:10px;color:#010000"><b>Della</b></h3>
                        <p style="margin:10px;color:#202122">
                           The super economical Della album is printed on generation next of photo paper offering more Reality & Clarity to Images 
                        </p>
                        <p style="margin:10px;color:#202122">
                           Panoramic uninterrupted view can have better design possibilities and hence add beauty to album.
                        </p>
                            <p style="margin:10px;color:#202122">
                           This exclusive album is most suitable for portrait and candid style of photography.
                        </p>
                            </div>
                    </th>
                    <th rowspan="20">
                        <div id="h1" class="panel" style="margin:10px;">
                            ...
                            <h5 style="margin-left:10px">12 x 18 / 9 x 12, 12 x 24, 12 x 30/15 x 24, 12×36/18×24</h5>
                            <h4 style="margin-left:10px">Pages</h4>
                            <h5 style="margin-left:10px">Minimum Pages: 50</h5>
                            <h5 style="margin-left:10px">Maximum Pages: 50</h5>

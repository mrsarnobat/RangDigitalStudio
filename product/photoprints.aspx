<%@ Page Language="C#" AutoEventWireup="true" CodeFile="photoprints.aspx.cs" Inherits="product_photoprints" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Photoprints</title>
    ...
    <!-- Collect the nav links, forms, and other content for toggling -->
        ...
        <div align="left" style="margin-left:30px">
            <table>
                <tr>
                    <th>
                        <h2 class="text-style"><b>Photoprints</b></h2>
                    </th>
                </tr>
                <tr>
                  <th>
                      <a href="photprint/photo_prints.aspx" style="text-decoration:none">
                    <img src="../Images/photoprint.png" class="img-gal-size-land" />
                     <p><h3 style="color:aliceblue;">&nbsp;&nbsp;&nbsp;Photo Prints</h3></p>
                          </a>
                  </th>
                    </tr>
                </table>

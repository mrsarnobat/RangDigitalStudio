...
public partial class services_cameraonrent : System.Web.UI.Page
{
    ...
    protected void txt_addr_TextChanged(object sender, EventArgs e)
    {
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            con.Open();
            cmd = new SqlCommand("INSERT INTO cameraonrent (name, emailid, contactno, address, stdate, enddate, model)VALUES ('" + txt_name.Text + "','" + txt_email.Text + "','" + txt_mobileno.Text + "','" + txt_add.Text + "','" + txt_sdate.Text + "','" + txt_edate.Text + "','" + DropDownList1.Text + "')", con);
            cmd.ExecuteNonQuery();
